...
const imgUrl = "https://i.namu.wiki/i/P5NEPFBj2qigbRMwAfPhm1eErZ21EHlHXcGDQVSxsdeNibI0mXU09-OTinaZ5L2hKEZqt_gQGT-xaezXNJxJig.webp";
const text = "Hello, JSX";
const num = 10;
const imgUrl2 = "https://www.irobotnews.com/news/photo/202302/30766_66430_946.jpg";
...
function getImg(){
    return  <img src={imgUrl2} alt="호빵맨" width={300}/>
}
...
const JavaScript = () => {
  return (
    <div>
        ...
        <ul>
            <li>
                <img src={imgUrl} alt="호빵맨" width={300}/>
            </li>
        </ul>
